...
```{r fit-mvebnm-mixsqp, results="hide"}
set.seed(1)
...
but, perhaps more compellingly, in this example mix-SQP assigns zero
weight to a redundant mixture component, whereas the EM algorithm does
not:

```{r compare-mixture-weights}
print(fit.teem$w,digits = 3)
print(fit.mixsqp$w,digits = 3)
```
